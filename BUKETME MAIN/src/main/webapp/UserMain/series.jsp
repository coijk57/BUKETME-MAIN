...
<meta charset="UTF-8">
<!-- 참조 slick(슬라이드)파일 경로================================================================ -->
	<link rel="stylesheet" type="text/css" href="../css/SeriesCss/slick/slick.css"/>
	<link rel="stylesheet" type="text/css" href="../css/SeriesCss/slick/slick-theme.css"/>
	<script type="text/javascript" src="//code.jquery.com/jquery-1.11.0.min.js"></script>
	<script type="text/javascript" src="//code.jquery.com/jquery-migrate-1.2.1.min.js"></script>
	<script type="text/javascript" src="../css/SeriesCss/slick/slick.min.js"></script>
	<script type="text/javascript" src="../js/SeriesJS/maincontentslist.js"></script>
<!-- 참조 장르, 추천순 버튼 자바스크립트 경로============================================================ -->	
	<script type="text/javascript" src="../js/SeriesJS/SeriesJS.js"></script>
<!-- ======================================================================================== -->

<!-- 참조 css파일 경로============================================= -->
<link rel="stylesheet"  href="../css/SeriesCss/Series.css"/>
<link rel="stylesheet" href="../css/SeriesCss/moviemodal.css">
<!-- ========================================================== -->
...
<script type="text/javascript">
	...
	$(function() {
		...
		$(".category").on("click", function() {
		    ...
		    $.ajax({
				type: "post",
				url: getContextPath() + "/SeriesSelect.do",
				data: {
						"category": category,
						"rating": rating
						},
				...
				complete: function(data) {
					...
					for(var i=0;i<list.ArraySize;i++) {
						$(".movie_contents_list").append("<div><a href='#moviedetail' id='moviedetail'><img class='imgsize imageFile' src='"+list.imgArray[i]+"'></a></div>");
					}
...
<section id="section">
	<div class="main_wrapper">
		...
		<c:forEach var="list" items="${recentSeriesList}">
			<div class="movie_ad">
		...
		<div class="movie_list_wrapper">
			<div class="usermovie_list select1">
				...
				<c:choose>
					<c:when test="${empty seriesWatchingList}">
						<div class="empty-comment1">시청중인 시리즈가 없습니다.</div>
					</c:when>
					<c:otherwise>
						<div class="movie_contents_list">
							<c:forEach var="list" items="${seriesWatchingList}">
								<div>
			...
			<div class="usermovie_list select2">
				<c:forEach var="list1" items="${seriesCategoryList.get('category')}" varStatus="status">
				
					<c:choose>
						<c:when test="${empty seriesCategoryList.get('seriesCategoryList').get(status.index)}">
						...
						<c:otherwise>
							...
							<div class="movie_contents_list">
								...
								<c:forEach var="list2" items="${seriesCategoryList.get('seriesCategoryList').get(status.index)}">
									<div>
										<a href="#moviedetail" id="moviedetail">
